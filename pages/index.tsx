...
export default function Home({ posts }: { posts: Post[] }) {
	return (
		<>
			...
			<main className="w-full bg-gray-50 flex items-center justify-center">
				<div className="min-h-screen">
					<header className="w-full py-12 md:py-24 lg:py-32 border-b flex items-center justify-center">
						<div className="space-y-2">
							<h1 className="text-3xl font-bold sm:text-4xl md:text-5xl lg:text-6xl text-center">
								Welcome to Our Blog
							</h1>
							<p className="mx-auto text-gray-500 md:text-xl text-center">
